...
DROP TABLE IF EXISTS `localization_post_relashionships`;
CREATE TABLE `localization_post_relashionships` (
  `toilette_id` bigint(20) unsigned NOT NULL,
  `localization_id` bigint(20) unsigned NOT NULL,
  PRIMARY KEY (`toilette_id`,`localization_id`)
